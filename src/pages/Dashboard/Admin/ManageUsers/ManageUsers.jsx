...
import { BookOpen, Crown, Search, Shield, Sparkles, Trash2, Users } from "lucide-react";
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-black text-white">
             <span className="bg-gradient-to-r from-[#D8B4FE] via-[#A78BFA] to-[#818CF8] bg-clip-text text-transparent"> Manage Users</span> 👥
            </h1>
