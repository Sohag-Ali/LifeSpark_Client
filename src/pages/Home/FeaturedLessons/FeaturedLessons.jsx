                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">

                     {
                        lessons.map((lesson) => (
                           ...
                           <div
                              key={lesson._id}
                              className="bg-white rounded-[30px] shadow-xl hover:shadow-2xl transition duration-300 overflow-hidden group border border-base-300"
                           >
                              ...
                              <div className="p-6">
                                 ...
                                 {/* title */}
                                 <h3 className="text-2xl font-black line-clamp-2">
                                 ...
                                 {/* description */}
                                 <p className="text-gray-500 leading-8 mt-4 line-clamp-3">
